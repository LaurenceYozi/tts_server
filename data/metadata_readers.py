...
def cath_v1(metadata_path: str, column_sep='|') -> dict:
    text_dict = {}
...
if __name__ == '__main__':
    metadata_path = '/home/laurence_chen/project/Cath_word_sent/metadata.csv'
    d = get_preprocessor_by_name('cath_v1')(metadata_path)
